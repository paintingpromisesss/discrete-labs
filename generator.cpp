...
int main() {
    ...
    generate_data("./data/narrow_range.txt", 1000, 1009, 1'000'000);

    // 2. Широкий диапазон (все 65536 ключей, 1M пар)
    generate_data("./data/wide_range.txt", 0, 65535, 1'000'000);

    // 3. Один ключ (1M пар)
    generate_data("./data/single_key.txt", 42, 42, 1'000'000);
